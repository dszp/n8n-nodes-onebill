...
export const partnerOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Delete contacts from a partner',
				action: 'Delete contacts from a partner',
			},
			{
				name: 'Get',
				value: 'get',
			...
			},
			{
				name: 'Resume',
				value: 'resume',
				description: 'Resume a suspended partner account',
				action: 'Resume a partner',
			},
			{
				name: 'Suspend',
				value: 'suspend',
				description: 'Suspend a partner account',
				action: 'Suspend a partner',
			},
			{
				name: 'Update',
				value: 'update',
...
export const partnerFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'json',
				default: '[]',
				description: 'The contacts for this partner as a JSON array',
	...
	// ----------------------------------
	{
		...
		description: 'The account number of the partner',
	},
